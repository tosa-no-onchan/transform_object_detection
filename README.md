...
#### 5. 画像サイズを、DETR 用に変更  
[resize2dtr_size.py](https://github.com/tosa-no-onchan/annotation/blob/main/resize2dtr_size.py)

#### 6. YOLO アノテーション to metadata.jsonl  
  $ python yolo2huggingface_metadata2.py

#### 7. torch 転移学習済モデルを onnx に変換  
  $ python zasou_dtr2onnx.py  

#### 8. onnx のスリム化と入力サイズの Fix  
